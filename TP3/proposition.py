...
class Data:
    ...
    def creer_donnees():
        """Sources:
        bdd-donnees-annexes-fr-2023//annexe 1 --> naissances
...
class Modele:
    ...
    def main_agrege(self)-> dict:
        ...
        def lst_to_dict(agrege:GroupAgrege):
        ...
        dct = {}
        dct.update(lst_to_dict(GroupAgrege('0 - 19 ans', int(df.iloc[row]['de_0_à_19_ans']))))
        dct.update(lst_to_dict(GroupAgrege('20 - 59 ans', int(df.iloc[row]['de_20_à_59_ans']))))
        dct.update(lst_to_dict(GroupAgrege('60 - 64 ans', int(df.iloc[row]['de_60_à_64_ans']))))
        dct.update(lst_to_dict(GroupAgrege('65 - 99 ans', int(df.iloc[row]['de_65_à_99_ans']))))
        dct.update({'Total':sum(val for val in dct.values())})
        return dct
